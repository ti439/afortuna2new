...
const $$ToursTeaser = createComponent(($$result, $$props, $$slots) => {
  ...
  const cards = [
    {
      ...
      description: "Rappel, canyoning y experiencias intensas con guias expertos.",
      image: aventura,
      tag: "Favorito del viajero"
    },
    {
      title: "Naturaleza y vida silvestre",
      description: "Caminatas y observacion de fauna en paisajes unicos.",
      image: naturaleza,
      tag: "Ideal en familia"
    },
    {
      title: "Vistas y paisajes iconicos",
      description: "Volcan, cataratas y senderos para conectar con el Arenal.",
      image: tours,
      tag: "Mas reservado"
    }
  ];
  return renderTemplate`${maybeRenderHead()}<section class="py-16 bg-white text-gray-800"> <div class="max-w-6xl mx-auto px-4 md:px-8"> <div class="flex flex-col md:flex-row md:items-end md:justify-between gap-6 mb-10"> <div> <span class="text-xs uppercase tracking-[0.3em] text-emerald-600">Experiencias recomendadas</span> <h2 class="text-3xl md:text-4xl font-bold mt-3">
Antes de elegir hotel, mira estos tours
</h2> <p class="mt-3 text-gray-600 max-w-2xl">
Reserva directo y asegura tu cupo. Tours seleccionados por calidad, seguridad y guia local.
...
}, "C:/Users/gamer/Documents/GitHub/afortuna2new/src/components/ToursTeaser.astro", void 0);

export { $$ToursTeaser as $ };
